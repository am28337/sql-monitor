<# 0.4. - Develop a script that emails the file to a designated mailbox. #> 
...
$LogFilePath = 'C:\Users\Andrew\Documents\_Gups\SQL-Monitor\sql-monitor-'+$DateToday+'.txt'
...
Send-MailMessage -From "SERVERNAME <servername@domain.co.uk>" `
    -To "am28337@ou.ac.uk" `
